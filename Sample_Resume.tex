...
\textbox{\textbf{\mbox{Doctor of Philosophy, Genetic Epidemiology}}\hfill}\textbox{\hfill Present (start Oct 2020)}\\
\textbox{University of Queensland, \textit{Brisbane, Australia (remote, from University of Bristol)}} \\
% Comment the following if not relevant
\mbox{\small{Scholarship: \textit{Research Training Program}}, Australian Commonwealth government}
...
\begin{multicols}{2}[]
  \begin{itemize}
    ...
    \item Collaboration Tools: GitHub, Dropbox, Google Drive
    \item Interpersonal skills: active listening, conflict mediation, facilitation, empathy, team working, providing constructive feedback
...
%----------------------------------------------------------------------------------------
% TODO: find a way of adding DOI
\begin{rSection}{Publications}
  \bibliographystyle{plain}
\nobibliography{ref}
  \begin{itemize}
    \item \bibentry{scaini_role_2020}
  \end{itemize}
\end{rSection}
%----------------------------------------------------------------------------------------
